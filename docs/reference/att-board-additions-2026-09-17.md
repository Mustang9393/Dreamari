...
| Device request asks plain questions only (what, do you have a working computer at home, mostly for, pick up or ship); the tile shows "Under review · reply within five days" after sending; eligibility runs behind the scenes with the school and Compudopt. Enterprise Impact gains a Devices panel: laptops vs hotspots, fulfilled of requested, waiting, next distribution. Opportunities filter drawn as light chips under a "Where" label, not a second tab bar | Students are never shown criteria such as the poverty line (direct feedback, 18 Sept 2026); what was supplied belongs on the dashboard; two stacked segmented bars clashed |
| Safeguarding pass (v2.0 only): Report on every insight and answer card (flag icon, reasons sheet, "Sent to moderators"); AT&T professionals verified as "Background checked · Work email verified · AT&T Believes volunteer"; tutoring copy says the session is in a moderated room with a transcript and staff able to join; a Safety panel on enterprise Impact (volunteers verified, open flags, average review, sessions logged, "Under 18: public questions only, no private messages"). The contact-details filter was already on every composer through the shared Composer and InlineAsk | Minors and adults: public only, filtered, moderated, verified, visible to staff, reportable (discussion, 18 Sept 2026) |
| Business & Finance on the board: Danielle Marshall, Senior Manager, Financial Planning & Analysis (AT&T Finance), with a profile, an answer on getting into corporate finance, a People row and a Team seat; AT&T Finance Internship and Business Sales Leadership Development Program added to Opportunities (both real AT&T programs); Home puts the student's own field first; Learn regroups by the student ("For Investment Banking and Airline Pilot": spreadsheets, Excel, job searching, a career plan unit, online safety, video calls, résumé) with AT&T's technology units after; provider named on every unit | A student exploring Investment Banking had nothing to learn or ask here. AT&T is a Fortune 15 employer with a large finance organisation; its partners teach skills, not majors (direct feedback, 18 Sept 2026) |
| Volunteer Today opens with "Since you were last here": reads on your answer, a student's thank-you with their face, a student acting on your résumé notes, new questions waiting; every row is a way in | The reason a volunteer comes back is seeing what the last visit did (proposal, 18 Sept 2026; built on request) |
