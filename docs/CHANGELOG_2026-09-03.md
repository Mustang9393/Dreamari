...
- Community cards: the stat boxes and company marks sit on a light blur instead of a dark fill, so they read as part of the photo rather than chips; Open is a frosted rounded-rectangle button, no blue.
