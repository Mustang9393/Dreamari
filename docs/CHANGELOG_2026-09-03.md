...
- Connect, Professionals to Follow: no more cards. A row of large portraits, each ringed in its firm's colour, a follow badge on the corner, first name, role, and the firm's mark. Scrolls sideways on phones, wraps on wider screens. Tapping the face opens the profile.
