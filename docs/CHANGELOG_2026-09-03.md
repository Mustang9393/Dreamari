...
- Profile, later: one card holds the tab bar and whichever panel is open. Inside it nothing is a card again: Overview tiles, Plan sections and the resume panel are drawn with borders on the shared surface, the way the career report keeps one sheet.
