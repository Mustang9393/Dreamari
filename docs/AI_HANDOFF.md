...
- Open: DEMO_ALWAYS_SHOW_GUIDE flag in MatchLab still true (demo). Chrome extension for the user's Gmail was not connected at session end; the requested summary email was not sent by the agent.
