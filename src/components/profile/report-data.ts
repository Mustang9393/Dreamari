...
// No Reach/Target/Safety: there is no explainable admissions model behind
// those labels here, so the report uses what is actually true instead.
export type CollegeStatus = "Saved" | "Explore" | "Check requirements" | "Discuss with counselor";
...
export const CAREER_REPORTS_V2: Record<string, CareerReportV2> = {
  ...
  "software-engineer": {
    ...
    colleges: [
      { name: "University of Washington", location: "Seattle, WA", control: "Public", length: "4-year", program: "BS Computer Science", cost: "About $13K a year in-state tuition and fees", outcome: "84% graduate within 6 years", requirements: "CS admission is separate and competitive, check requirements", why: "Strong ties to major tech companies in the same city.", status: "Saved" },
      { name: "San Jose State University", location: "San Jose, CA", control: "Public", length: "4-year", program: "BS Software Engineering", cost: "About $8K a year in-state tuition and fees", outcome: "68% graduate within 6 years", requirements: "Check impacted-major requirements", why: "In Silicon Valley at a public price.", status: "Explore" },
      { name: "UMass Lowell", location: "Lowell, MA", control: "Public", length: "4-year", program: "BS Computer Science", cost: "About $16K a year in-state tuition and fees", outcome: "68% graduate within 6 years", requirements: "Check requirements for the co-op program", why: "Co-op program means paid work experience before you graduate.", status: "Check requirements" },
      { name: "Carnegie Mellon University", location: "Pittsburgh, PA", control: "Private", length: "4-year", program: "BS Computer Science", cost: "About $65K a year tuition before aid", outcome: "93% graduate within 6 years", requirements: "Extremely competitive, check requirements and aid", why: "Well known for computing. Worth discussing cost and odds honestly.", status: "Discuss with counselor" },
    ],
    comparison: {
