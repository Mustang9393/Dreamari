...
export const ROUTE_DETAILS: Record<string, RouteDetail> = {
  ...
  "ib-uni-state": {
    ...
    payoff: { time: "~2-3 yrs", tag: "Totally manageable", avgLoan: "$68K", startSalary: "$82K", years: [{ label: "Year 1", amount: "$82K" }, { label: "Year 2", amount: "$88K" }, { label: "Year 3", amount: "$95K" }], budget: { income: "$6,833/mo", loan: "$640/mo", keep: "$6,193/mo", pct: 9 }, takeaway: "Strong pay with a fraction of the debt of a target school." },
  ...
  "pilot-uni": {
    ...
    payoff: { time: "~5-7 yrs", tag: "Big loan, big paychecks", avgLoan: "$210K", startSalary: "$90K regional", years: [{ label: "Year 1", amount: "$90K", note: "regional airline" }, { label: "Year 2", amount: "$105K" }, { label: "Year 3", amount: "$200K+", note: "major airline" }], budget: { income: "$7,500/mo", loan: "$1,450/mo", keep: "$6,050/mo", pct: 19 }, takeaway: "Costs more, but the 1,000-hour R-ATP break gets you hired sooner." },
  ...
  "pe-uni-state": {
    ...
    payoff: { time: "~2-3 yrs", tag: "Totally manageable", avgLoan: "$68K", startSalary: "$85K", years: [{ label: "Year 1", amount: "$85K" }, { label: "Year 2", amount: "$100K" }, { label: "Year 3", amount: "$140K", note: "if you land the PE seat" }], budget: { income: "$7,083/mo", loan: "$640/mo", keep: "$6,443/mo", pct: 9 }, takeaway: "Less debt buys you patience for the longer climb into PE." },
