...
// Demo requests go to the product inbox (direct instruction, 11 Sept 2026:
// not a personal address). There is no backend in this prototype (one
// client-error endpoint, nothing else), so the form composes a mailto: with
// the fields and hands off to the visitor's mail client.
