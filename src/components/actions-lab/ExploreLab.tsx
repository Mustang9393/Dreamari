"use client";
/* eslint-disable @typescript-eslint/no-unused-vars -- a lab copy of the real page: it keeps the real components' props and helpers so the rest of the file stays identical to the original */

// DEMO-ONLY: Career actions lab copy of the real Explore page
// (src/components/app/ExploreExperience.tsx, forked 26 Sept 2026). Identical
// except for the For You reel's action controls, their feedback, and links
// that stay inside the lab. Reads and writes the lab's own store
...
import { CompanyVideoCards } from "@/components/app/CompanyVideoCards";
import {
  ALL_CATALOG_CAREERS,
  BROWSE_ARTS,
...
function DesktopPreferenceRail({
  ...
  return (
    <div className="hidden flex-col items-center gap-[var(--space-4)] lg:flex">
      <ReelColumn slug={slug} title={activeItem.title} lab={lab} />
    </div>
  );
}
