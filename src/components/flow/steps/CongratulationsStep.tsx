  ...
  return (
    <FlowCard>
      <div className="flex w-full items-start justify-center">
        <span className="flex items-center justify-center rounded-full bg-amber-100 p-4 dark:bg-amber-400/15">
          <StarIcon className="size-8 text-amber-600 dark:text-amber-300" />
        </span>
      </div>

      <div className="flex w-full flex-col items-center gap-2 text-center">
        <p className="text-[28px] leading-9 font-extrabold text-slate-900 dark:text-white">You did it!</p>
        <p className="text-base leading-[22px] font-bold text-amber-600 dark:text-amber-300">Your unique path is ready.</p>
