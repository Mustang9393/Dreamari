...
export const DECK: Career[] = [
  ...
  },
  {
    ...
    fontWeight: 700,
    salary: "$78K – $130K",
    employers: "Ralph Lauren · Nike · Zara",
    hook: "Sketch collection concepts, select fabrics and trims, drape and fit garments on forms, and review production samples with the studio team.",
    classes: "Studio Art, Sewing & Textiles, Graphic Design, Geometry, Art History",
    skills: "Concept Sketching, Draping & Patternmaking, Color Theory, Textile Selection, Trend Forecasting",
