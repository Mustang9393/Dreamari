...
export const INSIGHTS: Insight[] = [
  ...
  },
  {
    ...
    replies: [
      ...
      { proId: "pro-chen", body: "School projects count if you can explain your own contribution. 'We built' is fine; follow it with 'my part was…'", postedAgo: "16h ago", likes: 12 },
    ],
  },
  {
  ...
  },
  {
    ...
    replies: [
      ...
      { proId: "pro-okafor", body: "Early. But honestly the wake-up matters less than the habit: same checklist, every morning, no exceptions.", postedAgo: "22h ago", likes: 11 },
    ],
  },
  {
  ...
  },
  {
    ...
    replies: [
      ...
      { proId: "pro-reyes", body: "Nights, at first — more room to think. Then days, once thinking got faster.", postedAgo: "20h ago", likes: 9 },
    ],
  },
  {
  ...
  },
  {
    ...
    replies: [
      ...
      { proId: "pro-cole", body: "Especially video. A before/after cut with one sentence on what you changed is a portfolio piece.", postedAgo: "1d ago", likes: 10 },
    ],
  },
  {
