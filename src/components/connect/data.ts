...
export type Pro = {
  ...
  priorRole?: string;
  /** Company ERGs they've chosen to share (e.g. "Black Leadership Network ·
   *  Apple") -- another way for a student to find a professional they
   *  personally relate to, alongside `topics`/`world`. Opt-in per pro, so
   *  most records simply omit it. */
