...
const AVATAR_PHOTO: Record<string, string> = {
  ...
  "Elena Martinez": `${AV}/pro-martinez.jpg`,
  "Amara Okafor": `${AV}/pro-okafor.jpg`,
  "Marcus Reyes": `${AV}/pro-reyes.jpg`,
  ...
  "Danielle Brooks": `${AV}/pro-brooks.jpg`,
  "Leo Fontaine": `${AV}/pro-fontaine.jpg`,
  "Omar Haddad": `${AV}/pro-haddad.jpg`,
  "Camille Vega": `${AV}/pro-vega.jpg`,
  "Samuel Adler": `${AV}/pro-adler.jpg`,
  "Isabella Rossi": `${AV}/pro-rossi.jpg`,
  "Arjun Nair": `${AV}/pro-nair.jpg`,
  "Marisol Ortega": `${AV}/pro-ortega.jpg`,
  "Erik Lindqvist": `${AV}/pro-lindqvist.jpg`,
  "Simone Bell": `${AV}/pro-bell.jpg`,
