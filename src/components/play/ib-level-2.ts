  ...
  beats: [
    {
      ...
      body: "This is standard for the industry. The early years mean long days and late nights to build experience fast. The hours ease up as you move up.",
      note: "Accept to unlock the next level.",
      cta: "Accept Offer",
    },
    {
      kind: "card",
    ...
    },
    {
      ...
      speaker: "Christina",
      step: { at: 2, of: 5 },
      setup: '"Five things an Analyst does."',
    ...
    },
    {
      ...
      note: "Morning review starts in a few minutes.",
    ...
    },
    {
      ...
      note: "Your work is being noticed.",
      cta: "Continue",
    },
    {
      kind: "card",
