...
export const RN_LEVEL_1: Level = {
  ...
  beats: [
    ...
    // ---- Rosa: two cards, the screen before she first acts ----
    {
      ...
      speaker: "Narrator",
      art: `${ART}/rosa.jpg`,
      artAlt: "Rosa in navy scrubs at the nurses' station, stethoscope around her neck.",
    ...
    // ---- Denise: two cards, the screen before she first matters ----
    {
      ...
      speaker: "Narrator",
      art: `${ART}/denise.jpg`,
      artAlt: "Denise in a dark blazer over navy scrubs, the floor visible behind her.",
    ...
    //      line of any kind: what he does is described, never explained. ----
    {
      ...
      speaker: "Narrator",
      art: `${ART}/tyler.jpg`,
      artAlt: "Tyler in navy scrubs by the nurses' station, mid-gesture.",
