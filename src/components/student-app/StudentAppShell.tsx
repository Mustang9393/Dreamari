    ...
    <header className="sticky top-0 z-50 border-b border-[var(--component-home-navigation-border)] bg-[var(--component-home-navigation-background)]/92 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-[1440px] items-center justify-between gap-4 px-4 sm:h-18 sm:px-6 lg:px-10">
        ...
        <div className="flex shrink-0 items-center gap-2.5">
          ...
          <Link href="/career-report" aria-label="Open career profile" aria-current={activeTab === "profile" ? "page" : undefined} className={`flex size-10 items-center justify-center rounded-full text-sm font-extrabold focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-action-secondary)] ${activeTab === "profile" ? "ring-2 ring-[var(--color-action-secondary)] ring-offset-2 ring-offset-[var(--component-home-navigation-background)]" : ""} bg-[var(--component-home-navigation-active-background)] text-[var(--component-home-navigation-active-text)]`}>AK</Link>
        </div>
      </div>
    </header>
  );
